		...
		<div className='flex flex-1 items-center justify-center py-12'>
			<div className='w-full max-w-lg text-center'>
				<div className='relative mx-auto mb-8 h-40 w-40'>
					...
					<div className='absolute inset-4 rounded-full bg-violet-50 dark:bg-violet-900/20' />
					<div className='absolute inset-0 flex items-center justify-center'>
						<div className='rounded-2xl bg-white p-6 shadow-xl dark:bg-zinc-800'>
							<Icon icon='Variable' size='text-5xl' className='text-violet-500' />
						</div>
					</div>
				...
				{hasFilters ? (
					<>
						...
						<p className='mb-6 text-zinc-500 dark:text-zinc-400'>
							We couldn&apos;t find any variables matching your filters.
							<br />
					...
					<>
						...
						<p className='mb-2 text-zinc-500 dark:text-zinc-400'>
							Store environment variables to use across your workflows.
						</p>
						<p className='mb-8 text-sm text-zinc-400 dark:text-zinc-500'>
							Variables can store API URLs, configuration values, and more.
						</p>
						...
						<div className='mb-8 grid grid-cols-3 gap-4 text-left'>
							<div className='rounded-xl bg-zinc-50 p-4 dark:bg-zinc-800/50'>
								<div className='mb-2 flex h-10 w-10 items-center justify-center rounded-lg bg-violet-100 dark:bg-violet-900/30'>
									<Icon icon='Settings02' className='text-violet-500' size='text-xl' />
								</div>
								<div className='text-sm font-medium text-zinc-700 dark:text-zinc-300'>Config</div>
								<div className='text-xs text-zinc-400'>Store settings</div>
							</div>
							<div className='rounded-xl bg-zinc-50 p-4 dark:bg-zinc-800/50'>
								<div className='mb-2 flex h-10 w-10 items-center justify-center rounded-lg bg-blue-100 dark:bg-blue-900/30'>
									<Icon icon='EyeOff' className='text-blue-500' size='text-xl' />
								</div>
								<div className='text-sm font-medium text-zinc-700 dark:text-zinc-300'>Secrets</div>
								<div className='text-xs text-zinc-400'>Masked values</div>
							</div>
							<div className='rounded-xl bg-zinc-50 p-4 dark:bg-zinc-800/50'>
								<div className='mb-2 flex h-10 w-10 items-center justify-center rounded-lg bg-emerald-100 dark:bg-emerald-900/30'>
									<Icon icon='Share01' className='text-emerald-500' size='text-xl' />
								</div>
								<div className='text-sm font-medium text-zinc-700 dark:text-zinc-300'>Shared</div>
